...
module top (input clk);
        ...
        wire [31:0] pc, pc_in, branch, pc_branch, jump_address, pc_final;
        ...
        //PCSource mux
        mux2_1 #(32)muxPcSource_inst(.a(pc_in), .b(branch), .sel((PCSRC & ZERO)), .out(pc_branch));
        
        //jump
        shift_jump shiftJump_inst(pc, instruction, jump_address);
        
        //PCJump mux
        mux2_1 #(32)muxJump_inst(.a(pc_branch), .b(jump_address), .sel(JUMP), .out(pc_final));
